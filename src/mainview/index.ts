...
import type { FishNetDpsActorRow, FishNetDpsSkillRow } from "../fishnet/dps-meter.ts";
...
openReplayButton.addEventListener("click", () => void electroview.rpc?.request.chooseReplay({}));
