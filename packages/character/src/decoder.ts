...
const STAT_NAMES: Record<number, string> = {
  ...
  120: "Critical defence", 121: "Perfect dodge", 142: "Status damage", 152: "ATK per STR", 151: "MATK per STR",
...
const PERCENT_STATS = new Set([47, 48, 52, 57, 58, 63, 64, 65, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 79, 90, 98, 102, 104, 121, 159, 160, 184, 187]);
