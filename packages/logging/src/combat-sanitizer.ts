...
const COMBAT_KEYS = new Set(["kind", "operation", "tick", "actorId", "mobId", "displayName", "value", "team", "sourceId", "sourceLabel", "recoveryStyle", "attribution", "hitResult", "duplicatesDamageEvent", "critical", "targetId", "statusId", "level", "action", "phase", "skillId", "stacks", "rpc", "remainingSeconds", "barrierBefore", "barrierAfter", "incomingActorId", "incomingSourceId", "incomingSourceLabel"]);
